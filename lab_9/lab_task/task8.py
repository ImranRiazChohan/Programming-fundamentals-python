...
my_top_student.discard('ali khan')
print("now my top scoring students name after removing extra name are: ",my_top_student)
print("now after removing i have :"+str(len(my_top_student))+" student in my list")
print(my_top_student)
my_top_student.pop()
print("Now my top scoring students name after removing extra name are : ",my_top_student)
print("now after removing I have :"+str(len(my_top_student))+"stuednt of my list")